...
import com.erban.pulltorefresh.internal.EmptyViewMethodAccessor;
import com.erban.pulltorefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
    ...
    private boolean mLastSecondItemVisible;
    private OnScrollListener mOnScrollListener;
    private OnLastItemVisibleListener mOnLastItemVisibleListener;
    private OnLastSecondItemVisibleListener mOnLastSecondItemVisibleListener;
    ...
    public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
        ...
        if (null != mOnLastSecondItemVisibleListener) {
            mLastSecondItemVisible = (totalItemCount > 0) && (firstVisibleItem + visibleItemCount == totalItemCount - 6);
        }
    ...
    public final void onScrollStateChanged(final AbsListView view, final int state) {
        ...
        if (/*state == OnScrollListener.SCROLL_STATE_IDLE &&*/ null != mOnLastSecondItemVisibleListener && mLastSecondItemVisible) {
            mOnLastSecondItemVisibleListener.onLastSecondItemVisible();
        }
    ...
    public final void setOnLastSecondItemVisibleListener(OnLastSecondItemVisibleListener listener) {
        mOnLastSecondItemVisibleListener = listener;
    }
