 ...
 *******************************************************************************/
package com.erban.pulltorefresh;
...
import com.erban.pulltorefresh.internal.FlipLoadingLayout;
import com.erban.pulltorefresh.internal.LoadingLayout;
import com.erban.pulltorefresh.internal.RotateLoadingLayout;
import com.erban.pulltorefresh.internal.Utils;
import com.erban.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    protected AnimationStyle mLoadingAnimationStyle = AnimationStyle.getDefault();
    ...
    public final boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        if (mOnRefreshListener2 != null && listView != null) {
            ...
            mOnRefreshListener2.onTouchDownEvent(event, position, isNewItem);
    ...
    /**
     * @return Either {@link com.cm.pulltorefresh.PullToRefreshBase.Orientation#VERTICAL} or
     * {@link com.cm.pulltorefresh.PullToRefreshBase.Orientation#HORIZONTAL} depending on the scroll direction.
     */
     ...
     * {@link com.cm.pulltorefresh.PullToRefreshBase.State#PULL_TO_REFRESH} state.
     */
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.cm.pulltorefresh.PullToRefreshBase.State#REFRESHING} or {@link com.cm.pulltorefresh.PullToRefreshBase.State#MANUAL_REFRESHING} state.
     *
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.cm.pulltorefresh.PullToRefreshBase.State#RELEASE_TO_REFRESH} state.
     */
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.cm.pulltorefresh.PullToRefreshBase.State#RESET} state.
     */
    ...
    public static enum Mode {
         ...
         * {@link com.cm.pulltorefresh.PullToRefreshBase#setRefreshing() setRefreshing()}.
         */
    ...
    public static interface OnLastSecondItemVisibleListener {

        /**
         * Called when the user has scrolled to the end of the list
         */
        public void onLastSecondItemVisible();
    ...
    public static interface OnPullEventListener<V extends View> {
         ...
         * @param direction   - One of {@link com.cm.pulltorefresh.PullToRefreshBase.Mode#PULL_FROM_START} or
         *                    {@link com.cm.pulltorefresh.PullToRefreshBase.Mode#PULL_FROM_END} depending on which direction
         *                    the user is pulling. Only useful when <var>state</var> is
         *                    {@link com.cm.pulltorefresh.PullToRefreshBase.State#PULL_TO_REFRESH} or
         *                    {@link com.cm.pulltorefresh.PullToRefreshBase.State#RELEASE_TO_REFRESH}.
         */
